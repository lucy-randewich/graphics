...
ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, Colour trigColour, glm::vec3 normal, std::string material, std::string object) :
        vertices({{v0, v1, v2}}), texturePoints(), colour(std::move(trigColour)), normal(normal), material(material), object(object) {}
